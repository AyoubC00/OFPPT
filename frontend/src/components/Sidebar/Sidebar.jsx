...
import { Squares2X2Icon, BookOpenIcon, PaperClipIcon, HomeIcon, DocumentIcon, CalendarDaysIcon, MegaphoneIcon, SparklesIcon, ArrowUpOnSquareIcon, DocumentCheckIcon } from '@heroicons/react/24/outline'
...
const Sidebar = () => {
  ...
  const ICONS = {
    ...
    absence: <DocumentCheckIcon className={iconStyle} />
  }
